...
namespace SoftwareNinjas.BranchAndReviewTools.Core.Stub
{
    ...
    public class SourceRepository : ISourceRepository
    {
        ...
        /// </returns>
        public virtual string ComputePendingDifferences(IEnumerable<object> pendingChangeIds)
        {
            return String.Empty;
        }
        ...
        /// An ordered list of <see cref="MenuAction"/> instances from which to build a menu.
        /// </returns>
        public virtual IList<MenuAction> GetActionsForPendingChanges(IEnumerable<object> pendingChangeIds)
        {
            return MenuAction.EmptyList;
        }
        ...
        /// A single string representing the selected pending differences to commit.
        /// </returns>
        public virtual string ComputeRevisionDifferences(IEnumerable<object> changeIds)
        {
            return String.Empty;
        }
        ...
        /// An ordered list of <see cref="MenuAction"/> instances from which to build a menu.
        /// </returns>
        public virtual IList<MenuAction> GetActionsForRevisionChanges(IEnumerable<object> changeIds)
        {
            return MenuAction.EmptyList;
        }
    }
